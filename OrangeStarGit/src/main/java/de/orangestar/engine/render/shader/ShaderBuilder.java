...
public class ShaderBuilder {
    ...
    /**
     * Creates, compiles and returns the sets up the shader.
     * @return A shader
     */
    public Shader build() {
        ...
        Logger.debug(ShaderBuilder.class, "Vertex-Shader:" + strVertex.toString());
        Logger.debug(ShaderBuilder.class, "Fragment-Shader:" + strFragment.toString());
     ...
     * @param srcs Custom vertexshader code
     * @return <i>this</i>
     */
     ...
     * For the shader variable/method naming conventions see {@link Shader}
     * @param srcs Custom fragmentshader code
     * @return <i>this</i>
     */
    ...
    private void vs_in(StringBuilder builder) {   
        ...
        builder.append("uniform int " + Shader.UniAttribNameInstanced + ";\n");
    ...
    private void vs_main(StringBuilder builder) {        
        ...
        if (_vertexCustomCode != null) {
            ...
            builder.append("    if (" + Shader.UniAttribNameInstanced + " != 1) {\n");
